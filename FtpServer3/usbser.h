/*
  Created on: 29 mai 2015 by Jean-Michel Gallego
  
  This file is mostly a copy of a portion of the file
    C:\ChibiStudio\chibios3\demos\STM32\RT-STM32F407-OLIMEX_E407-LWIP-FATFS-USB\main.c
    that is part of
